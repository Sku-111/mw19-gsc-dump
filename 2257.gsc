...
spawn_mindia_juggs()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1427E( "hoopty", 1 );
    var_0.id = 9;
...
spawn_manual_turret()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_1416C( "hoopty", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_1413D( "hoopty" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_14178( "hoopty", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_14171( "hoopty", ::hoopty_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1417B( "hoopty_mp", 3 );
}
...
hoopty_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_14138( var_2, "hoopty", var_0 );
