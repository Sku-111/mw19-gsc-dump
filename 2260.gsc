...
waitthenrespawnsnowballs()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1427E( "large_transport", 1 );
    var_0.id = 5;
...
waitthencheckendgame()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_1416C( "large_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_1413D( "large_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_14178( "large_transport", 10 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_14171( "large_transport", ::large_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1417B( "large_transport_mp", 3 );
}
...
large_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_14138( var_2, "large_transport", var_0 );
