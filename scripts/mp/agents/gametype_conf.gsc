...
{
    thread scripts\mp\bots\bots_gametype_conf.gsc::bot_conf_think();
}
...
agent_squadmember_conf_think()
{
    ...
    if ( gettime() > self.next_time_check_tags )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            var_2 = self.owner scripts\mp\bots\bots_gametype_conf.gsc::bot_find_visible_tags( 1, var_1, var_0 );
