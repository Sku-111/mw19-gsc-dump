...
{
    thread scripts\mp\bots\bots_gametype_to_bhd.gsc::bot_bhd_think();
}
...
agent_squadmember_bhd_think()
{
    ...
    if ( gettime() > self.next_time_check_tags )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            var_2 = self.owner scripts\mp\bots\bots_gametype_to_bhd.gsc::bot_find_visible_tags( 1, var_1, var_0 );
            self.tags_seen_by_owner = scripts\mp\bots\bots_gametype_to_bhd.gsc::bot_combine_tag_seen_arrays( var_2, self.tags_seen_by_owner );
        }
    }

    self.tags_seen_by_owner = scripts\mp\bots\bots_gametype_to_bhd.gsc::bot_remove_invalid_tags( self.tags_seen_by_owner );
    var_3 = scripts\mp\bots\bots_gametype_to_bhd.gsc::bot_find_best_tag_from_array( self.tags_seen_by_owner, 0 );
